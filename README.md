# 👋 Salut, moi c’est Furkan Ciraci

🎓 Développeur Full Stack en alternance, passionné par le développement logiciel, l’intelligence artificielle, la data et l’automatisation.

Je travaille principalement sur des projets web, backend, data et SaaS, avec une approche orientée produit, performance et automatisation.
...
![VPN](https://img.shields.io/badge/VPN-0052CC?style=for-the-badge&logo=wireguard&logoColor=white)
![Pentest](https://img.shields.io/badge/Pentest-000000?style=for-the-badge&logo=kalilinux&logoColor=white)
...
Plateforme de gestion documentaire permettant de gérer la demande, le dépôt et le traitement de justificatifs.

#### MonPiston

Web app d’aide à la recherche d’alternance, stage et emploi, intégrant :

- génération IA de lettres de motivation ;
...
- mise en place de solutions SaaS.
